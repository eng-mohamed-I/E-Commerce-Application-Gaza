    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-light">
      <div className="container-fluid">
        <Link
          ...
          to="/"
          style={{ margin: "0 112px", fontWeight: "700" }}
        >
          Gaza Store
        </Link>
        <button
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            {auth?.user && (
              <li className="nav-item">
                <p style={{ color: "#DB4444" }} className="mt-2 ms-5 fw-bold">
                  <FormattedMessage
                    id="hello"
                    values={{ username: auth.user.username.toUpperCase() }}
                  />
                </p>
              </li>
            )}
          ...
          <ul className="navbar-nav me-auto mx-4 mb-2 mb-lg-0 gap-4">
            <li>
              <Link to="/wishlist">
                ...
                >
                  <Badge
                    value={auth?.user ? wishlistItemCount : "0"}
                    severity="danger"
                    style={{ fontSize: "10px" }}
                  ></Badge>
                </i>
            ...
            <li>
              <Link to="/cart">
                ...
                >
                  <Badge
                    value={auth?.user ? cartItemCount : "0"}
                    severity="danger"
                    style={{ fontSize: "10px" }}
                  ></Badge>
                </i>
          ...
          <Dropdown className="mx-4">
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item onClick={() => setLocale("ar")}>
                عربي
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          {auth?.user && (
            <div className="nav-item btn btn-danger">
              <div role="button" className="" onClick={logOut}>
                Logout
              </div>
            </div>
          )}
